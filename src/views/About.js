...
const About = () => (
  <div>
    ...
    <div>Graph icon by Mister Pixel from the Noun Project</div>
  	<br/><div>Disclaimer: All content found on the Halyos Website, including: text, images, audio, or other formats were created for informational purposes only. The Content is not intended to be a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition. Never disregard professional medical advice or delay in seeking it because of something you have read on this Website.

If you think you may have a medical emergency, call your doctor, go to the emergency department, or call 911 immediately. We do not recommend or endorse any specific tests, physicians, products, procedures, opinions, or other information that may be mentioned on this site. Reliance on any information provided by this site is solely at your own risk.

Links to external content are taken at your own risk. We are not responsible for the claims of external websites and education companies.</div>
  </div>
);

export default About;

//https://www.flaticon.com/free-icon/arrow_90418
