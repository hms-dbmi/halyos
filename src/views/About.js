...
const About = () => (
  <div className="about-us-container top-border scrollbar">
    <h1 className="about-heading">XXX: A patient-facing visual EHR interface for longitudinal risk awareness</h1>

    <h3 className="description">What is XXX?</h3>
    <p>XXX, is a visual EHR web app that complements the functionality of existing patient portals. XXX is designed to integrate with existing EHR systems to help patients interpret their health data. The source code is freely available on XXX.</p>

    <h3 className="description">How does XXX work?</h3>
    <p>The XXX application utilizes the <a href="https://smarthealthit.org/" target="_blank">SMART on FHIR</a> platform to create an interoperable interface that provides <b>interactive visualizations of clinically validated risk scores</b> and longitudinal data derived from a patient’s clinical measurements. These visualizations allow patients to investigate the relationships between key clinical measurements and risk over time. By allowing patients to set hypothetical future values for these clinical measurements, patients can see how changes in their health will impact their risks. Using XXX, patients are provided with the opportunity to actively improve their health based on increased understanding of longitudinal information available in EHRs and to begin a dialogue with their healthcare providers.</p>

    <h3 className="description">Acknowledgements</h3>
    <p>First off, thanks to everyone that helped out with brainstorming, design, and technical issues! Specifically, we would like to thank the members of the XXX Lab, as well as XXX, for their mentorship and support.</p>
