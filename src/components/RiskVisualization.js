...
export default class RiskVisualization extends Component {
	...
	render() {
		return (
			<div className={this.props.emphasize ? 'present-risk' : ''}>
				<div className='header'> Risk: {this.props.score}% <span className="context"> within {this.props.context} years </span></div>
