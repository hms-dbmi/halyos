			...
			<OverlayTrigger placement={this.props.placement} overlay={this.props.tooltip}>
				<svg width="70%" height="70%" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style={{enableBackground: 'new 0 0 58.45 58.45'}} xmlSpace="preserve">
					...
					l-4.698-4.698H24.55L39.148,49.048z" />
			          <rect x="6.806" y="4.368" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -4.0618 9.806)" style={{fill: '#AFB6BB'}} width={6} height="10.877" />
					...
					s1.023-0.391,1.414,0l6.321,6.321c0.391,0.391,0.391,1.023,0,1.414C57.961,58.352,57.706,58.45,57.45,58.45z" />
			          ...
			          <rect x="20.814" y="14.814" transform="matrix(0.7071 0.7071 -0.7071 0.7071 21.8135 -9.0354)" style={{fill: '#556080'}} width={2} height={14} />
