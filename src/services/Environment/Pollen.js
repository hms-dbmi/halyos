...
export function getPollen(location) {
	...
	var data;
	if ((this.state.data === null) && location){
			$.getJSON('http://dataservice.accuweather.com/forecasts/v1/daily/1day/' + location.zip_code + '?apikey=Dkvl9QArEY7A7Kzofew70OEHTNDYBjEA&details=true', function(data) {
					  data = data; //does this work lol idk js
					}.bind(this));
