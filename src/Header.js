        ...
        <Navbar.Collapse>
          <Nav>
            ...
            <NavDropdown eventKey={3} title="Risk Scores" id="basic-nav-dropdown">
              ...
              <LinkContainer to={'/risk/Kidney_Failure'}><MenuItem eventKey={3.1}>Kidney Failure</MenuItem></LinkContainer>
              <LinkContainer to={'/risk/COPD_Mortality'}><MenuItem eventKey={3.1}>COPD</MenuItem></LinkContainer>
